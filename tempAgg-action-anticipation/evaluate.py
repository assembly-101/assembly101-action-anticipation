...
from utils.challenge import head_tail_div, seen_or_unseen_div, topk_recall, get_tail_top5, unseen_div_top5
...
if __name__ == '__main__':
    ...
    # if not len(np_segs) == 0:
    #     print('[ERROR!] missing test segments')
    #     exit()
    # else:
